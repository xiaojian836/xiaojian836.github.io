window.onresize = (function() {
    ...
    var $select = function(comms) {
        ...
        for (var i = 0; i < comms.length; i++) {
            ...
            switch (comm.length) {
                case 0:
                    ...
                    break;
                case 1:
                    /* recv */ if (chan.$sendQueue.length !== 0 || chan.$buffer.length !== 0 || chan.$closed) {
                        ready.push(i);
                    }
                    break;
                case 2:
        ...
        if (selection !== -1) {
            ...
            switch (comm.length) {
                ...
                case 1:
                    /* recv */ return [selection, $recv(comm[0])];
                case 2:
                    /* send */ $send(comm[0], comm[1]);
                    return [selection];
            }
        }
        var entries = [];
        ...
        for (var i = 0; i < comms.length; i++) {
            (function(i) {
                ...
                switch (comm.length) {
                    case 1:
                        /* recv */ var queueEntry = function(value) {
                            f.selection = [i, value];
                            removeFromQueues();
                            $schedule(thisGoroutine);
                        };
    ...
    $packages["main"] = (function() {
        var $pkg = {},
            $init, js, Duration, DigitalRain, waterDrop, GlyphCanvas, ptrType, sliceType, sliceType$1, funcType, ptrType$1, sliceType$2, ptrType$2, ptrType$3, funcType$1, sliceType$3, mapType, mapType$1, overlap, BlogLinkColor, BlogLinkOverColor, BlogLink, level1Cols, level2Cols, lowGlyphCanvases, highGlyphCanvases, backgrounds, index, main, itoa, ftoa, randi, NewDigitalRain, shortLink, NewGlyphCanvas;
        js = $packages["github.com/gopherjs/gopherjs/js"];
                ...
                s: while (true) {
                    switch ($s) {
                        case 0:
                            ...
                            _tuple = NewDigitalRain($global.document.getElementById('CanvasBG'), level2Cols, 2, 8, 0.25);
                            rain1[0] = _tuple[0];
                            err = _tuple[1];
                            /* */
                        ...
                        case 2:
                            ...
                            _tuple$1 = NewDigitalRain($global.document.getElementById('CanvasBG'), level1Cols, 2, 12, 1);
                            rain2[0] = _tuple$1[0];
                            err = _tuple$1[1];
                            /* */
                            if (!($interfaceIsEqual(err, $ifaceNil))) {
                        ...
                        case 5:
                            ...
                            rain2[0].Clicked = (function(rain1, rain2) {
                                return function() {
                                    ...
                                    $global.document.getElementById('CanvasBG').style.background = $externalize((x$4 = (_r$6 = index % 2, _r$6 === _r$6 ? _r$6 : $throwRuntimeError("integer divide by zero")), ((x$4 < 0 || x$4 >= backgrounds.$length) ? ($throwRuntimeError("index out of range"), undefined) : backgrounds.$array[backgrounds.$offset + x$4])), $String);
                                };
                            })(rain1, rain2);
                            $s = -1;
                            return;
        ...
        DigitalRain.ptr.prototype.layout = function() {
            ...
            r.canvas.style.width = $externalize("100%", $String);
            r.canvas.style.height = $externalize("100%", $String);
                ...
                s: while (true) {
                    switch ($s) {
                        case 0:
                            ...
                            /* if (r.overLink($parseInt(ev.x) >> 0, $parseInt(ev.y) >> 0)) { */
                        case 1:
                            $global.location = $externalize(BlogLink, $String);
                            $s = 3;
                            continue;
                            /* } else { */
                        case 2:
        ...
        DigitalRain.ptr.prototype.drawTitles = function() {
            ...
            y = 0;
            if (r.linkover) {
                y = r.drawTitle(shortLink(BlogLink), BlogLinkOverColor, 15 * r.ratio, y);
            } else {
                y = r.drawTitle(shortLink(BlogLink), BlogLinkColor, 15 * r.ratio, y);
            }
        };
            ...
            s: while (true) {
                switch ($s) {
                    ...
                    case 1:
                        ...
                        overlap = 0;
                        BlogLinkColor = "rgba(107,165,184,.5)";
                        BlogLinkOverColor = "rgba(107,165,184,1)";
                        BlogLink = "http://youngsers.fun";
                        level1Cols = 40;
                        level2Cols = 60;
                        index = 1;
                        if ($pkg === $mainPkg) {
